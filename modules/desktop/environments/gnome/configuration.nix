...
in {
  config = lib.mkIf config.eos.desktop.gnome.enable {
    flake.modules.homeManager.jamie = {
      pkgs,
      osConfig,
      ...
    }: {
      ...
      dconf = {
        ...
        settings = {
          ...
          "org/gnome/shell".welcome-dialog-last-shown-version = "48.0";
          ...
          # Search Light
          "org/gnome/shell/extensions/search-light" = with osConfig.lib.stylix.colors; let
